...
// исходный пр€моугольник берЄтс€ с отступом в радиус от своих краЄв
...
begin
  ...
  for y := zRealRect.Top to zRealRect.Bottom do
    ...
    begin
      // сначала заполним первые элементы - квадратом исходного изображени€
      zpossrc := 0;
      ...
      // в конце - положим результирующую €ркость
