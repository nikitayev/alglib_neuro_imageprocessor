...
begin
  ...
  begin
    ...
    begin
      ...
      Buf[2] := Lin1[cx];
      Buf[3] := Lin2[cx];
      PBGR(D)^.b := (word(Buf[0].b) + word(Buf[1].b) + word(Buf[2].b) + word(Buf[3].b)) shr 2;
      PBGR(D)^.g := (word(Buf[0].g) + word(Buf[1].g) + word(Buf[2].g) + word(Buf[3].g)) shr 2;
      PBGR(D)^.r := (word(Buf[0].r) + word(Buf[1].r) + word(Buf[2].r) + word(Buf[3].r)) shr 2;
      Inc(PBGR(D));
    end;
  end;
end;
